        ...
        <div class="search">
          <div class="search_form">
            <div class="search_input">
              <label class="label" for="">编码</label>
              <input class="input_text" type="text" placeholder="请输入编码" v-model="codeValue" />
            </div>
            <div class="search_input">
              <label class="label" for="">类型名称</label>
              <input class="input_text" type="text" placeholder="请输入类型名称" v-model="typeNameValue" />
            </div>
            <div class="input_btn">
        ...
        <div class="add_content">
          <ul>
            <li v-for="(v, k) of detailsList.add" :key="k" class="add_input">
              <div>
                <span class="add_content_span">{{ v }}</span>
                <el-input type="text" v-model="input1[k]" :placeholder="`请输入` + v" maxlength="50"></el-input>
                <span class="add_content_tip">{{ detailsFont[k] }}</span>
              </div>
            </li>
          </ul>
        </div>
